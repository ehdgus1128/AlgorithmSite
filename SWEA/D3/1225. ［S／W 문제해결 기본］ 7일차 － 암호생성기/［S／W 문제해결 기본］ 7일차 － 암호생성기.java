...
//				System.out.print(queue.peek()+" ");
				if(i == cnt - 1) {
					int firstValue = 0;
					int decrease = 1;
					while(true) { // 마지막 원소 값이 0일 때까지 -1,-2,-3,-4,-5
						firstValue = queue.poll();
						if(firstValue > 0) {
							firstValue = firstValue - decrease;
							// 감소 사이클
//							if(decrease == 5) decrease = 1;
//							else decrease++;
							decrease = (decrease % 5) + 1;
							if(firstValue > 0) queue.offer(firstValue);
							else {
								firstValue = 0;
